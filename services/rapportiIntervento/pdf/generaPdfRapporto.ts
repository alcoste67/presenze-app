// Generatore PDF del rapporto di intervento: condiviso tra il
// download (route GET) e l'invio email (Task 5). Il PDF inviato e
// archiviato e' la copia legale: generato una volta, mai rigenerato.
...
export async function generaRapportoInterventoPdf(
  rapporto: RapportoInterventoCompleto,
