...
const PUBLIC_ROUTES = [
  ...
  "/termini",
  "/firma-remota",
  "/checklist-wallbox/firma-remota",
];
...
export async function proxy(request: NextRequest) {
  ...
  if (
    ...
    !pathname.startsWith("/checklist-wallbox/firma-remota") &&
...
export const config = {
  matcher: [
    "/((?!_next/static|_next/image|favicon\\.ico|sw\\.js|api/|manifest\\.webmanifest|.*\\.(?:png|jpg|jpeg|svg|gif|webp|ico)$).*)",
  ],
};
